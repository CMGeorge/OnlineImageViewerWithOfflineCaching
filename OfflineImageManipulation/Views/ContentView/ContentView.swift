        ...
        NavigationStack {
            listView
                ...
                .overlay(alignment: .top) {
                    if let currentToastText = imageListViewModel
                        .currentToastText
                    {
                ...
                .animation(
                    ...
                    value: imageListViewModel.networkMonitor.connected
                )
                .onChange(of: imageListViewModel.networkMonitor.connected) {
                    wasConnected,
                    isConnected in
                    Task {
                        await imageListViewModel.handleConnectivityChange(
                            from: wasConnected,
                            to: isConnected
                        )
                    }
